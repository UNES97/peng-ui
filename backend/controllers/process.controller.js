            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: 'text',
                            text: `You're a frontend web developer with over 20 years of experience, specializing in ${framework} Framework. Your portfolio boasts over 400 professional websites. Given a description, you will generate a high quality, creative & professional clone responsive HTML with ${framework} Framework (If you need to add some css please use it in the header section), supporting both dark and light modes. The layout should render nicely on desktop, tablet, and mobile devices.
